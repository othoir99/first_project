...
<body class="bg-white text-gray-800">
                ...
                <div class="flex items-center space-x-6">
                    <div class="hidden md:flex items-center bg-gray-100 rounded-full px-4 py-2">
                        ...
                        <input type="text" placeholder="Search products..."
                            class="bg-transparent border-none focus:outline-none focus:ring-0 ml-2 w-40">
                    </div>
        ...
        <div class="container mx-auto px-4">
            <div class="flex flex-col md:flex-row items-center">
                <div class="md:w-1/2 mb-10 md:mb-0">
                    ...
                    <p class="text-lg text-gray-700 mb-8">Discover our new summer collection with fresh styles and
                        vibrant colors. Up to 40% off on selected items.</p>
                    <div class="flex space-x-4">
                        <a href="#"
                            class="bg-indigo-600 text-white px-6 py-3 rounded-lg font-medium hover:bg-indigo-700 transition duration-300">Shop
                            Now</a>
                        <a href="#"
                            class="border border-gray-800 text-gray-800 px-6 py-3 rounded-lg font-medium hover:bg-gray-800 hover:text-white transition duration-300">Explore</a>
                    </div>
                </div>
                <div class="md:w-1/2 flex justify-center">
                    <div class="relative">
                        <div
                            class="bg-white rounded-2xl shadow-xl p-2 transform rotate-3 w-64 h-80 flex items-center justify-center">
                            <img src="https://images.unsplash.com/photo-1496747611176-843222e1e57c?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1000&q=80"
                                alt="Fashion Model" class="rounded-xl object-cover w-full h-full">
                        </div>
                        <div
                            class="absolute top-10 -left-10 bg-white rounded-2xl shadow-xl p-2 transform -rotate-6 w-64 h-80 flex items-center justify-center">
                            <img src="https://images.unsplash.com/photo-1539109136881-3be0616acf4b?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1000&q=80"
                                alt="Fashion Model" class="rounded-xl object-cover w-full h-full">
                        </div>
                    </div>
                </div>
        ...
        <div class="container mx-auto px-4">
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-6">
                ...
                <div class="category-card relative rounded-xl overflow-hidden shadow-md h-64">
                    <img src="https://images.unsplash.com/photo-1490481651871-ab68de25d43d?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1000&q=80"
                        alt="Women's Fashion" class="w-full h-full object-cover">
                    <div
                        class="category-overlay absolute inset-0 bg-black bg-opacity-40 flex items-center justify-center opacity-0 transition-opacity duration-300">
                ...
                <div class="category-card relative rounded-xl overflow-hidden shadow-md h-64">
                    <img src="https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1000&q=80"
                        alt="Men's Fashion" class="w-full h-full object-cover">
                    <div
                        class="category-overlay absolute inset-0 bg-black bg-opacity-40 flex items-center justify-center opacity-0 transition-opacity duration-300">
                ...
                <!-- Category 3 -->
                <div class="category-card relative rounded-xl overflow-hidden shadow-md h-64">
                    <img src="https://images.unsplash.com/photo-1519457431-44ccd64a579b?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1000&q=80"
                        alt="Kids Fashion" class="w-full h-full object-cover">
                    <div
                        class="category-overlay absolute inset-0 bg-black bg-opacity-40 flex items-center justify-center opacity-0 transition-opacity duration-300">
                ...
                <!-- Category 4 -->
                <div class="category-card relative rounded-xl overflow-hidden shadow-md h-64">
                    <img src="https://images.unsplash.com/photo-1558769132-cb25c5d1ac7f?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1000&q=80"
                ...
                @foreach ($products as $item)
                    ...
                    <div class="product-card bg-white rounded-xl shadow-md overflow-hidden group">
                        <div class="relative overflow-hidden">
                            ...
                            <div
                                class="product-actions absolute top-4 right-4 opacity-0 transform translate-y-2 transition-all duration-300">
    ...
    <section class="py-16 bg-indigo-600 text-white">
        <div class="container mx-auto px-4 text-center">
            ...
            <p class="text-lg mb-8 max-w-2xl mx-auto">Don't miss our biggest sale of the season. Shop now and get
                amazing discounts on summer essentials.</p>
            ...
            <a href="#"
                class="bg-white text-indigo-600 px-8 py-3 rounded-lg font-bold text-lg hover:bg-gray-100 transition duration-300">Shop
                the Sale</a>
        </div>
    </section>
        ...
        <div class="container mx-auto px-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div class="bg-gray-50 rounded-xl p-6 shadow-sm">
                    ...
                    <p class="text-gray-600 mb-4">"I absolutely love my new dress from StyleHub! The quality is amazing
                        and it fits perfectly. Will definitely shop here again!"</p>
                    <div class="flex items-center">
                        <img src="https://images.unsplash.com/photo-1494790108755-2616b612b786?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=100&q=80"
                            alt="Customer" class="w-10 h-10 rounded-full object-cover mr-3">
                        <div>
                ...
                <div class="bg-gray-50 rounded-xl p-6 shadow-sm">
                    ...
                    <p class="text-gray-600 mb-4">"Fast shipping and great customer service. The jeans I ordered are
                        exactly as described and very comfortable. Highly recommend!"</p>
                    <div class="flex items-center">
                ...
                <div class="bg-gray-50 rounded-xl p-6 shadow-sm">
                    ...
                    <p class="text-gray-600 mb-4">"The summer collection is fantastic! I bought three items and they're
                        all high quality and stylish. Great prices too!"</p>
                    <div class="flex items-center">
    ...
    <section class="py-16 bg-gray-900 text-white">
        <div class="container mx-auto px-4 text-center">
            ...
            <p class="text-lg mb-8 max-w-2xl mx-auto">Subscribe to our newsletter and be the first to know about new
                arrivals, exclusive offers, and style tips.</p>
            <div class="max-w-md mx-auto flex">
                <input type="email" placeholder="Your email address"
                    class="flex-grow px-4 py-3 rounded-l-lg text-gray-800 focus:outline-none">
                <button
                    class="bg-indigo-600 px-6 py-3 rounded-r-lg font-medium hover:bg-indigo-700 transition duration-300">Subscribe</button>
            </div>
        </div>
    </section>
        ...
        <div class="container mx-auto px-4">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                ...
                <div>
                    ...
                    <p class="text-gray-400 mb-4">Your destination for modern and stylish clothing for every occasion.
                    </p>
                    <div class="flex space-x-4">
